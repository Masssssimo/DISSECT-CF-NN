...
public class InfrastructureModel {
	...
	public String toString() {
		...
		result.append(")]");
		*/
		final StringBuilder overAllocated = new StringBuilder();
		overAllocated.append(totalOverAllocated);
		final StringBuilder activePMs = new StringBuilder();
		activePMs.append(nrActivePms);
		final StringBuilder migrations = new StringBuilder();
		migrations.append(nrMigrations);
